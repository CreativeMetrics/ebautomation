...
check(count($clean) === 3, 'sanitize_email_blocks scarta i tipi sconosciuti e gli elementi non validi (' . count($clean) . ' invece di 3)', $failures);
...
save_email_template('bx', [
    ...
    'is_default' => false, 'blocks' => $blocks,
]);
